      ...
      <div className='footer'>
        <div className='footer__ctn ctn'>
            ...
            <ul className='footer__links'>
                <li className='footer__links__el'><a className='oldLace' href="http://christophersaenen.be">Christopher Saenen</a></li>
                ...
                <li className='footer__links__el'><a className='oldLace' href="http://www.heaj.be">HEAJ</a></li>
